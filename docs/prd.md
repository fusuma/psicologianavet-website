...
| 2025-10-06 | 1.1 | Updated to include Shadcn/UI setup and critical Acceptance Criteria (ACs) for security/business logic, aligning with the Fullstack Architecture document. | John (PM) |
